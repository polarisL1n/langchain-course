...
class ChatGroq:
    ...
    def __init__(self, model, temperature: float = 0, max_retries=2):
        self.model = model
...
def implement_compare_models(prompt):
    ...
    """
    # TODO: Your implementation here
    llama_4_model = implement_llama_4_model()
    llama_3_model = implement_llama_3_3_model()
    llama_4_query = implement_query_model(llama_4_model, prompt)
    llama_3_query = implement_query_model(llama_3_model, prompt)
    
    return {
        "llama-4-8b-instant": llama_4_query,
        "llama-3.3-70b-versatile": llama_3_query,
    }
